class ApprenticeContract {
  ...
  String? vchRLyThuyet;
  String? vchRThucHanh;
  String? vchRCompleteWork;
  String? vchRLearnWork;
  String? vchRThichNghi;
  String? vchRUseful;
  String? vchRContact;
  ...
  ApprenticeContract.fromJson(Map<String, dynamic> json) {
    ...
    if(json["vchR_LY_THUYET"] is String) {
      vchRLyThuyet = json["vchR_LY_THUYET"];
    }
    if(json["vchR_THUC_HANH"] is String) {
      vchRThucHanh = json["vchR_THUC_HANH"];
    }
    if(json["vchR_COMPLETE_WORK"] is String) {
      vchRCompleteWork = json["vchR_COMPLETE_WORK"];
    }
    if(json["vchR_LEARN_WORK"] is String) {
      vchRLearnWork = json["vchR_LEARN_WORK"];
    }
    if(json["vchR_THICH_NGHI"] is String) {
      vchRThichNghi = json["vchR_THICH_NGHI"];
    }
    if(json["vchR_USEFUL"] is String) {
      vchRUseful = json["vchR_USEFUL"];
    }
    if(json["vchR_CONTACT"] is String) {
      vchRContact = json["vchR_CONTACT"];
    }
    if(json["vcH_NEED_VIOLATION"] is String) {
  ...
  static List<ApprenticeContract> fromList(List<Map<String, dynamic>> list) {
    return list.map(ApprenticeContract.fromJson).toList();
  }
