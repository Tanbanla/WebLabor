class SectionManager {
  ...
  SectionManager({this.chREmployeeId, this.chREmployeeName, this.chREmployeeAdid, this.chREmployeeMail, this.chRPosition, this.chRPositionGroup});

  SectionManager.fromJson(Map<String, dynamic> json) {
  ...
  static List<SectionManager> fromList(List<Map<String, dynamic>> list) {
    return list.map(SectionManager.fromJson).toList();
  }
