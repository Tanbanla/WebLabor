...
class _UpdateDtmDueState extends State<_UpdateDtmDue> {
  ...
  void initState() {
    super.initState();
    edited = TwoContract.fromJson(widget.contract.toJson());

    // Khởi tạo selectedDate từ contract (ISO format)
    ...
    // Cập nhật edited với ngày đã chọn (lưu dưới dạng ISO)
